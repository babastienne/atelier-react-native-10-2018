 ...
 *
 */
const BoutonAction = ({nom, deleteAction, terminateAction}) => (
    <TouchableHighlight
        underlayColor='#efefef'
        style={styles.bouton}
        onPress={(nom == 'Supprimer') ? deleteAction : terminateAction}>
        <Text style={(nom == 'Supprimer') ? styles.supprimer : styles.termine}>
            {nom}
        </Text>
    </TouchableHighlight>
)
